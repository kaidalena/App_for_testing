...
class Expander(QWidget):
    def __init__(self, parent=None, title=None, animationDuration=200):
        ...
        self.toggleAnimation2 = QtCore.QSequentialAnimationGroup()
        ...
        self.contentAreaQStyle = QStyleSheet(QScrollArea, border='black')
        ...
        row += 1
        mainLayout.addWidget(self.contentArea, row, 0, 2, 3)
    ...
    def setWidget(self, contentLayout, height=1):
        """
        ...
        self.contentGridLayout = contentLayout
        scrollWidget = QWidget()
        scrollWidget.setLayout(contentLayout)
        self.contentArea.destroy()
        self.contentArea.setWidget(scrollWidget)
...
class QExpander(QWidget):
    ...
    def setDisabled(self, hide: bool):
        self.expander.toggleButton.setDisabled(hide)